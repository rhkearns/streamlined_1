...
const Brief = () => {
	return (
      ...
      <p>
        This will allow you to build a strong foundation and prepare you for success. We want you to be able to focus on the core ideas of your business, rather than spending your time thinking about how to best communicate with clients and vendors, organize files, manage projects, etc.
      </p>
		</div>
	);
};
