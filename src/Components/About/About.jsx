		...
		<div className="about-section">
			...
			<div id="about-blurb">
				<p>
					...
					Libero Canto School of Singing, Mood Bars, Unf*ck Your Brain,
					Overflow, Thinkertales, Arena Holdings, Cultural Road Mapp, Time Inc.,
					...
					managers, and operations managers that are ready to work with you and
					your business.
				</p>
			</div>
		</div>
