...
const Issues = () => {
  return (
    <div id="issues-section">
      <h1 id="issues-header">We work through an array of administrative issues including:</h1>
      <div id="issues-blocks-section">
        <h1 className='issue-block'>Custom Email Domains</h1>
        <h1 className='issue-block'>File Organization</h1>
        <h1 className='issue-block'>Communication Tools</h1>
